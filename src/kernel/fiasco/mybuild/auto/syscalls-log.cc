...
#line 9 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"

extern "C" void sys_ipc_wrapper(void);
#line 11 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"
extern "C" void sys_ipc_log_wrapper(void);
#line 78 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"

/** IPC tracing.
 */
extern "C" void sys_ipc_trace_wrapper(void);
#line 82 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"
extern "C" void sys_ipc_wrapper();

#line 12 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"


/** IPC logging.
    called from interrupt gate.
 */
void FIASCO_FLATTEN sys_ipc_log_wrapper()
{
...
#line 83 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/syscalls-log.cpp"



void FIASCO_FLATTEN sys_ipc_trace_wrapper()
{
  Thread *curr = current_thread();
