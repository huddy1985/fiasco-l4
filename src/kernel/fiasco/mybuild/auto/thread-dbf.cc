...
#line 23 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/ia32/32/thread-dbf.cpp"


bool Thread::may_enter_jdb = false;

#line 26 "/media/fedora_work/project/real-time/l4re/src/kernel/fiasco/src/kern/ia32/32/thread-dbf.cpp"
